...
public class Main 
{
	...
	public static MethodArray methods;
	...
	{
		String[] testFiles = new String[]{ "Test2.class",
				};
		...
		Method main = methods.getMethodByName("main");
		interpreter.interpretMethod(main, new ArrayList<Integer>());
